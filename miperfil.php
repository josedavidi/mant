      ...
      <div class="row">
        ...
        <div class="col-sm-4" style="margin-top: 3%;">
          ...
          <form action="controlador/editarPerfil.php" method="POST">
            ...
            <input type="tel" name="celular" class="form-control" required placeholder="Celular" value="<?php echo $datos['movil'] ?>"><br>
            <input type="password" name="clave" class="form-control" required placeholder="Clave"><br>
            <button class="btn btn-dark btn-block">Guardar</button>
          </form>
        </div>
        <div class="col-sm-4"></div>
      </div>
