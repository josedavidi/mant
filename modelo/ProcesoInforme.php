...
if(mysqli_num_rows($validarSiExiste)>0){
	echo "<i class='fas fa-skull-crossbones fa-lg text-danger'></i> Ciudado, no dañes el sistena";
	return false;
}

$guardarProcesoInforme = $db->query("INSERT INTO proceso_informe VALUES(0,'$equipo_id','$proceso_id',1,'$fecha')");
